...
export function CalloutsPage(): JSX.Element {
  ...
  return (
    <div className="flex flex-col gap-5 max-w-4xl mx-auto w-full px-4 sm:px-6 py-6">
      ...
      {!publicKey ? (
        <section aria-label="Sign in required" className="flex flex-col items-center gap-4 rounded-2xl border border-white/10 bg-bg-secondary/55 p-8 text-center animate-fade-in">
          <div className="flex size-12 items-center justify-center rounded-full border border-primary-green/30 bg-primary-green/10 text-primary-green">
            <svg className="size-5" aria-hidden="true" width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M17.9961 13.9999C19.6529 13.9999 20.9961 12.6568 20.9961 10.9999C20.9961 9.34307 19.6529 7.99993 17.9961 7.99993M12.8254 17.9999C12.4136 19.1651 11.3023 19.9999 9.99609 19.9999C8.33924 19.9999 6.99609 18.6568 6.99609 16.9999V15.4999M6.99829 6.49993V15.4999M17.9961 4.36864V17.6312C17.9961 18.3084 17.3372 18.7897 16.6921 18.5839L3.69214 14.4363C3.27754 14.304 2.99609 13.9188 2.99609 13.4836V8.51626C2.99609 8.08107 3.27754 7.69585 3.69214 7.56357L16.6921 3.41595C17.3372 3.21013 17.9961 3.6915 17.9961 4.36864Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
            </svg>
          </div>
          <div className="flex flex-col gap-1">
            <h2 className="text-base font-semibold text-text-primary">Sign in to see the latest callouts</h2>
            <p className="max-w-md text-sm text-text-tertiary">Connect your wallet to follow top callers, track their best calls, and watch new callouts land in real time.</p>
          </div>
          <button
            type="button"
            onClick={() => setWalletModalVisible(true)}
            className="inline-flex items-center justify-center rounded-full bg-primary px-4 py-2 text-sm font-semibold text-black transition-colors hover:bg-primary/90"
          >
            Sign in to view callouts
          </button>
        </section>
      ) : (
        <>
